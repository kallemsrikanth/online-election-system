...
<form id="form1" method="POST" action="adminresult1.php" >
<h1>View Result</h1>
	<table border="0" width="100%" />
	<tr><td width="20%" /><b>Select the Election to view Result</td><td>
	...
	<button type="submit"  value="View Result" style="-webkit-border-radius:10px; height:30px; width:100px;">View Result</button><br />
</section>
