...
/*while($row=mysqli_fetch_assoc($sql))
{
	...
	$img=$row['image'];
	$party=$row['party'];
	echo "<b>Candidate Name:</b>".$name."<br><b>Candidate Description:</b>".$desc."<br><b>Party Name:</b>".$party."<br>";
...
while($row=mysqli_fetch_assoc($sql)){
	echo "<tr><td><b>" . $row['cid'] . "</td><td><b>" . $row['cname'] . "</td><td><b>" . $row['description'] . "</td><td><b>" . $row['party'] . "</td><td><b>" . "<img src='",$row['image'],"' width='75' height='75' />" . "</td></tr>";  //$row['index'] the index here is a field name
}
echo "</table>";
?>
</table>
